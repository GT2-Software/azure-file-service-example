...
public class PrintService {
    ...
    public JSONObject printInformation() {
        ...
        client.apps().deployments().list().getItems().forEach(deployment -> {
            ...
            sb.append("{Deployment Name: " + deployment.getMetadata().getName() + "}").append("\n");
            sb.append("{Deployment namespace: " + deployment.getMetadata().getNamespace() + "}").append("\n");
            sb.append("Deployment creation timestamp: " + deployment.getMetadata().getCreationTimestamp() + "}")
                    .append("\n");
        });
